...
def main():
    ...
    # tx = acct.deploy(CoffeeCoin, gas_limit=8000000, gas_price=web3.toWei("5", "gwei")) # Deploy to Ropsten

    tx = acct.deploy(CoffeeCoin, gas_limit=3999999, gas_price=0)  # Deploy to local Ganache
